...
//git branch -m main ESC_SolidityCode
//git fetch origin
//git branch -u origin/ESC_SolidityCode ESC_SolidityCode
...
constructor(string memory Emirates Sea Token_, string memory EST_) {
    _Emirates Sea Token /=/ Emirates Sea Token_;
    _EST /=/ EST_;
}
